...
- [Unbrowse](https://github.com/unbrowse-ai/unbrowse) - API-native agent browser. Replaces Playwright/Puppeteer with direct route resolution for AI agents. 3.6x faster, 90% cheaper.

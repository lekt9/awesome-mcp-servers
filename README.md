...
- [Unbrowse](https://github.com/unbrowse-ai/unbrowse) - API-native agent browser that discovers internal website APIs from traffic and replaces browser automation with direct API calls. 3.6x faster across 94 benchmarked domains.
